            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{isset($admin['user']['avatar']) ? $admin['user']['avatar'] : asset('/img/avatar.png')}}" onerror="javascript:this.src='{{asset('/img/avatar.png')}}';this.onerror = null" class="user-image" alt="用户头像">
                        <span class="hidden-xs">{{isset($admin['user']['nickname']) ? $admin['user']['nickname'] : ''}}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="{{isset($admin['user']['avatar']) ? $admin['user']['avatar'] : asset('/img/avatar.png')}}" onerror="javascript:this.src='{{asset('/img/avatar.png')}}';this.onerror = null" class="img-circle" alt="用户头像">
                            <p>
