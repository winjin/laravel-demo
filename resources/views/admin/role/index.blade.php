...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    <form class="form-inline searchForm" id="searchForm" action="{{route('admin.admin_role.index')}}" method="GET">
                        ...
                        <div class="form-group">
                            <button onclick="clearSearchForm()" class="btn btn-sm btn-default" type="button"><i class="fa  fa-eraser"></i> 清空查询 </button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header">
                    <div>
                        <a title="添加" data-toggle="tooltip" class="btn btn-primary btn-sm " href="{{route('admin.admin_role.add')}}">
                        ...
                        <a class="btn btn-success btn-sm ReloadButton" data-toggle="tooltip" title="刷新"
                           data-id="checked" data-url="{{route('admin.admin_role.del')}}">
                ...
                <div class="box-body table-responsive">
                    <table class="table table-hover table-bordered datatable" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="td-do">
                                <a href="{{route('admin.admin_role.access',['id'=>$item['id']])}}"
                                   class="btn btn-warning btn-xs" data-toggle="tooltip" title="授权">
                                    <i class="fa fa-key"></i>
                                </a>

                                <a href="{{route('admin.admin_role.edit',['id'=>$item['id']])}}"
